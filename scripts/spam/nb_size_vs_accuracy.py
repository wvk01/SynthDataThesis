...
for size in sample_sizes:
    ...
    test_accuracies_synthetic = [evaluate_test_set(test_set_path, tfidf_vectorizer_synthetic, nb_classifier_synthetic) for test_set_path in test_set_paths]
    ...
    test_accuracies_real_world = [evaluate_test_set(test_set_path, tfidf_vectorizer_real_world, nb_classifier_real_world) for test_set_path in test_set_paths]
...
plt.title('Sample Size vs Average Accuracy (Naive Bayes)')
plt.grid(True)
plt.legend()
plt.show()
