...
train_data = pd.read_csv('../../data/spam_data/preprocessed/synthetic/processed_fs2_n1000.csv')
...
plot_tree(dt_classifier, feature_names=tfidf_vectorizer.get_feature_names_out(), class_names=['Not Spam', 'Spam'], filled=True)
